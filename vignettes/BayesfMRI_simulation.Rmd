...
multi_session_result <- BayesGLM(data=multi_data$data, mesh=mesh, scale_BOLD = FALSE, scale_design = FALSE, verbose = TRUE, return_INLA_result=TRUE, num.threads = parallel::detectCores() - 2, avg_betas_over_sessions = T)
