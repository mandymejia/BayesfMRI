...
classical_estimates <- vec_to_image(single_session_classical$session_1, template_image = binary_template)
...
plot_BayesGLM_2d(single_session_result, mask = binary_template, zlim = c(-1.5,1.5))
```
