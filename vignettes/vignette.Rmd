...
```{r}
#fnames <- list.files("../vignette_data/glm_results")
#bglm2 <- BayesGLM2(file.path("../vignette_data/glm_results", fnames), gamma = 0, alpha = 0.05)
...
## 7.1 More on Design Matrix Construction
...
**Adaptive HRF modeling**: Using data from multiple subjects, we can learn a better HRF shape to use for different individuals
and across the brain.  The `BayesGLM()` function allows for a spatially-varying design, which results when the HRF is allowed
