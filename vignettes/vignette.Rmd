...
plot(bglm, Bayes=TRUE, idx="fear", title = "spatial GLM", what = 'surface') 
```

```{r, rgl=TRUE, format = "jpg"}
plot(bglm, Bayes=FALSE, idx="fear", title = "naive GLM", what = 'surface')
```
...
## e) Call `activations` to identify areas of activation
...
# Part 2: Second-Level Modeling


# Alternative Part 2: Prevalence Maps
...
```{r, rgl=TRUE, format = "jpg"}
plot(prev, what = 'surface')
```


# Bonus Section

## More on Design Matrix Construction
