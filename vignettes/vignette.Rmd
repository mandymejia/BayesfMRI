...
```{r}
getwd()
dir_data <- '../vignette_data/subject1/session1'
setwd(dir_data)
...
slices <- 27:30 
plot(bglm, Bayes=TRUE, idx="fear", title = "spatial GLM", slices = slices)
plot(bglm, Bayes=FALSE, idx="fear", title = "naive GLM", slices = slices)
```
...
plot(act, idx="fear", title = "spatial GLM", slices = slices)
plot(act0, idx="fear", title = "naive GLM (FWER)", slices = slices)
plot(act00, idx="fear", title = "naive GLM (FDR)", slices = slices)
```
...
plot(bglm1, Bayes=TRUE, idx="fear", title = "spatial GLM", what = 'surface') 
```

```{r, rgl=TRUE, format = "jpg"}
plot(bglm1, Bayes=FALSE, idx="fear", title = "naive GLM", what = 'surface')
```

Visualize the subcortical estimates for the "fear" condition

```{r, fig.height=4, fig.width=4, fig.show='hold'}
plot(bglm1, Bayes=TRUE, idx="fear", title = "spatial GLM", what = 'volume', slices = slices, n_slices=4) 
plot(bglm1, Bayes=FALSE, idx="fear", title = "naive GLM", what = 'volume', slices = slices, n_slices=4)
```
...
```{r, rgl=TRUE, format = "jpg"}
plot(act, Bayes=TRUE, idx="fear", title = "spatial GLM", what = 'surface') 
```

```{r, rgl=TRUE, format = "jpg"}
plot(act0, Bayes=FALSE, idx="fear", title = "naive GLM (FWER)", what = 'surface')
```

```{r, rgl=TRUE, format = "jpg"}
plot(act00, Bayes=FALSE, idx="fear", title = "naive GLM (FDR)", what = 'surface')
```
...
1. Multi-session modeling (BayesGLM2 and Prevalence Maps)

2. Spatially varying design
