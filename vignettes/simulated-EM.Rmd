...
```{r plot coefficients}
tile.plot(simulated_data$beta_coefficients$session_1[[1]], main = "True bbeta1", zlim = c(0,1))
tile.plot(simulated_data$beta_coefficients$session_1[[2]], main = "True bbeta2", zlim = c(0,1))
```
...
```{r View results}
tile.plot(em_result$betas_Bayesian$single_session$bbeta1, main = "Bayesian EM bbeta1", zlim = c(0,1))
tile.plot(glm_result$betas_Bayesian$single_session[[1]], main = "Bayesian GLM bbeta1", zlim = c(0,1))
tile.plot(em_result$betas_classical$single_session[[1]], main = "Classical bbeta1", zlim = c(0,1))
```
