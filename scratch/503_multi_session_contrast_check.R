# This is a script for running the contrast test
# Library and seed
set.seed(47401)
library(BayesfMRI)
...
INLA::inla.setOption(pardiso.license="~/licenses/pardiso.lic")
# inla.pardiso.check()
combined_session_results <- BayesGLM_surface(data = data, mesh = mesh, contrasts = contrasts_def, verbose = F)
saveRDS(combined_session_results, "scratch/503_combined_session_results.rds")
