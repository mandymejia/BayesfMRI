# This is a script to perform the analyses on the multisession data separately
# Library and seed
set.seed(47401)
library(BayesfMRI)
...
first_session_result <- BayesGLM_surface(data=data[1], mesh=mesh, verbose=F)
second_session_result <- BayesGLM_surface(data=data[2], mesh=mesh, verbose=F)
# Save the result
saveRDS(first_session_result, "~/github/BayesfMRI/scratch/502_multi_session_1_BayesGLM_results.rds")
saveRDS(second_session_result, "~/github/BayesfMRI/scratch/502_multi_session_2_BayesGLM_results.rds")
