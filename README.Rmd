...
The `BayesfMRI` R package includes the main function `BayesGLM`, which implements a spatial Bayesian GLM for task fMRI. It also contains two wrapper functions:

* `BayesGLM_cifti` – implements `BayesGLM` on CIFTI cortical surface fMRI data
