...
#'
#' @return A list containing the posterior probabilities of group membership, the estimated independent components S (a LxV matrix), their mixing matrix A (a TxL matrix), the number of nuisance ICs estimated (Q_nuis)
#' @export
