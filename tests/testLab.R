...
library(INLA)
#inla.setOption(pardiso.license = "/Users/analysis/Desktop/ASINag/pardiso.lic")
...
system.time(act3_Bayes <- id_activations_cifti(results_pw_one, threshold=0, method='Bayesian', alpha=0.05))
system.time(act3_classical1 <- id_activations_cifti(results_pw_one, threshold=0, method='classical', correction='FWER', alpha=0.05))
system.time(act3_classical2 <- id_activations_cifti(results_pw_one, threshold=0, method='classical', correction='FDR', alpha=0.05))
save(act_Bayes, act_classical1, act_classical2, file=file.path(main_dir, 'act_bayesianModel3.RData'))
